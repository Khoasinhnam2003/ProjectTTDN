...
function AddSalaryHistoryRoleManager() {
  ...
  useEffect(() => {
    ...
    // Kiểm tra vai trò Manager (giả định user data có roles)
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input
            ...
            required
            disabled={loading}
            max={new Date().toISOString().split('T')[0]} // Không cho phép chọn ngày trong tương lai (25/07/2025)
          />
        </div>
        <button
          type="submit"
...
export default AddSalaryHistoryRoleManager;