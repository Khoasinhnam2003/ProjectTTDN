...
function UpdateEmployeesRoleManager() {
    ...
    if (storedUser) {
      try {
        ...
        if (!roleArray.includes('Manager')) {
          setError('You do not have permission to edit employee information. Only Managers are allowed.');
          setLoading(false);
          return;
        }
      } catch (err) {
...
export default UpdateEmployeesRoleManager;