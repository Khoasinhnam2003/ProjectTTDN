...
namespace QuanLyNhanVien.Query.Application.UseCases.Roles
{
    ...
    public class GetRolesByIdQueryHandler : IRequestHandler<GetRolesByIdQuery, Role>
    {
        ...
        private readonly ILogger<GetRolesByIdQueryHandler> _logger;

        public GetRolesByIdQueryHandler(IUnitOfWork unitOfWork, ILogger<GetRolesByIdQueryHandler> logger)
        {
