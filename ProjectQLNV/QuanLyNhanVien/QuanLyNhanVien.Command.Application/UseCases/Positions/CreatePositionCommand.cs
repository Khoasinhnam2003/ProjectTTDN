...
{
    public record CreatePositionCommand : IRequest<Result<bool>>
    {
    ...
    public class CreatePositionCommandValidator : AbstractValidator<CreatePositionCommand>
    {
        ...
        public CreatePositionCommandValidator(ApplicationDbContext context)
        {
            ...
            RuleFor(x => x.PositionName)
                .CustomAsync(async (name, context, cancellationToken) =>
                {
                    var duplicate = await _context.Positions
                        .AnyAsync(p => p.PositionName == name, cancellationToken);
                    if (duplicate)
                    {
    ...
    public class CreatePositionCommandHandler : IRequestHandler<CreatePositionCommand, Result<bool>>
    {
